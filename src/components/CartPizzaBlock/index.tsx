...
export const CartPizzaBlock: React.FC<CartPizzaProps> = ({
  id,
  title,
  type,
  size,
  ...
  return (
    <div className="cart__item">
      ...
      <div className="cart__item-count">
        <button
          ...
          className={clsx('button button--outline button--circle cart__item-count-minus', {
            'cart__item-count-minus--disable': count === 1,
          })}
        >
          <svg
            width="10"
      ...
      <div className="cart__item-remove">
        <div onClick={onRemoveItems} className="button button--outline button--circle">
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
